...
const getSectionStyle = computed(() => {
  let paddingTop = route.meta.tips ? "var(--el-nav-height)" : "var(--el-nav-min-height)";
  return [
    hideTabs.value && layout ? `padding-top: ${paddingTop};` : "",
    !hideTabs.value && layout ? "padding-top: 81px;" : "",
    hideTabs.value && !layout.value ? `padding-top: ${paddingTop};` : "",
...
const getMainHeight = computed(() => {
  return [
    `height:calc(100vh - ${route.meta.tips ? "var(--el-nav-height)" : "var(--el-nav-min-height)"})`
  ];
});
        ...
        <KeepAliveFrame :currComp="Component" :currRoute="route">
          <template #default="{ Comp, fullPath, frameInfo }">
            ...
            >
              ...
              <div class="grow-app-main" :style="getMainHeight">
            ...
            <div v-else class="grow-app-main" :style="getMainHeight">
              <transitionMain :route="route">
                <keep-alive v-if="isKeepAlive" :include="usePermissionStoreHook().cachePageList">
                  <component
                    :is="Comp"
